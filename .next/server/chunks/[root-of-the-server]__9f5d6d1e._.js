...
"[project]/.next-internal/server/app/api/books/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
async function GET() {
    ...
    try {
        ...
        if (!data.items) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json([]);
        const books = data.items.map((item)=>({
                id: item.id,
                title: item.volumeInfo.title || "Título desconhecido",
                author: item.volumeInfo.authors?.[0] || "Autor desconhecido",
                cover: item.volumeInfo.imageLinks?.thumbnail || "https://via.placeholder.com/150x220?text=Sem+Capa"
            }));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9f5d6d1e._.js.map