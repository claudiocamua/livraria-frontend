...
function LoginPage() {
    _s();
    const { login } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthCotext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            if ((_err_response = err.response) === null || _err_response === void 0 ? void 0 : (_err_response_data = _err_response.data) === null || _err_response_data === void 0 ? void 0 : _err_response_data.error) {
...
_s(LoginPage, "hBR6zn6zvyyTOr4H5XWt3WQlnbY=", false, function() {
    return [
